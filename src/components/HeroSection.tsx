    ...
    >
      ...
      <div className="container mx-auto max-w-5xl z-10">
        <div className="flex flex-col items-start">
          <span className="font-serif italic text-lg opacity-75 mb-4">Frontend Developer</span>
          
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif mb-8 whitespace-nowrap overflow-hidden">
